  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        tile: {
          "unknown-background": "hsl(var(--tile-unknown-background))",
          "unknown-foreground": "hsl(var(--tile-unknown-foreground))",
          "neutral-background": "hsl(var(--tile-neutral-background))",
          "neutral-foreground": "hsl(var(--tile-neutral-foreground))",
          "red-background": "hsl(var(--tile-red-background))",
          "red-foreground": "hsl(var(--tile-red-foreground))",
          "blue-background": "hsl(var(--tile-blue-background))",
